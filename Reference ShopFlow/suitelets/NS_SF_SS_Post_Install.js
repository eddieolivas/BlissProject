function postInstallCombiner ()
{
	...
	try
	{
		...
		,	reference_container_path = '/Web Site Hosting Files/Live Hosting Files/SSP Applications/NetSuite Inc. - ShopFlow 1.06.0/Reference ShopFlow'
		...
		context.getSetting('SCRIPT', 'custscript_ns_sf_ignite_folders').split(';').forEach(function (path, index)
		{
